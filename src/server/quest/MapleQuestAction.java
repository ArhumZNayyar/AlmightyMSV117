...
import static client.inventory.MapleInventoryType.EQUIP;
import static client.inventory.MapleInventoryType.ETC;
import static client.inventory.MapleInventoryType.SETUP;
import static client.inventory.MapleInventoryType.USE;
...
import static server.quest.MapleQuestActionType.buffItemID;
import static server.quest.MapleQuestActionType.charismaEXP;
import static server.quest.MapleQuestActionType.charmEXP;
import static server.quest.MapleQuestActionType.craftEXP;
import static server.quest.MapleQuestActionType.exp;
import static server.quest.MapleQuestActionType.infoNumber;
import static server.quest.MapleQuestActionType.insightEXP;
import static server.quest.MapleQuestActionType.item;
import static server.quest.MapleQuestActionType.money;
import static server.quest.MapleQuestActionType.nextQuest;
import static server.quest.MapleQuestActionType.pop;
import static server.quest.MapleQuestActionType.quest;
import static server.quest.MapleQuestActionType.senseEXP;
import static server.quest.MapleQuestActionType.skill;
import static server.quest.MapleQuestActionType.sp;
import static server.quest.MapleQuestActionType.willEXP;
...
public class MapleQuestAction implements Serializable {
    ...
    public MapleQuestAction(MapleQuestActionType type, ResultSet rse, MapleQuest quest, PreparedStatement pss, PreparedStatement psq, PreparedStatement psi) throws SQLException {
        ...
        switch (type) {
            case item:
                ...
                rs = psi.executeQuery();
                while (rs.next()) {
                    items.add(new MapleQuestAction.QuestItem(rs.getInt("itemid"), rs.getInt("count"), rs.getInt("period"), rs.getInt("gender"), rs.getInt("job"), rs.getInt("jobEx"), rs.getInt("prop")));
                }
                rs.close();
                break;
            case quest:
    ...
    public final boolean RestoreLostItem(final MapleCharacter c, final int itemid) {
        if (type == MapleQuestActionType.item) {
            ...
            for (MapleQuestAction.QuestItem item : items) {
