...
import static client.MapleCharacter.tormentmode1;
...
public class MapleLifeFactory {
    ...
    public static int getTlvl (int Tlvl) {
        return Tlvl;
    }
 ...
 public static MapleMonsterStats getMonsterStats(int mid) {
        ...
        if (stats == null) {
            ...
            stats.setAcc((int) (MapleDataTool.getIntConvert("acc", monsterInfoData, 0) * GameConstants.accuracyMultiplier));
            stats.setEva((int) (MapleDataTool.getIntConvert("eva", monsterInfoData, 0) * GameConstants.evasiveMultiplier));
                stats.setExp((int)(mid == 9300027 ? 0 : (GameConstants.getPartyPlayEXP(mid) > 0 ? GameConstants.getPartyPlayEXP(mid) : MapleDataTool.getIntConvert("exp", monsterInfoData, 0)) * GameConstants.EXPMultiplier));
                ...
                stats.setExp((int)(mid == 9300027 ? 0 : (GameConstants.getPartyPlayEXP(mid) > 0 ? GameConstants.getPartyPlayEXP(mid) : MapleDataTool.getIntConvert("exp", monsterInfoData, 0))));
                stats.setHp((long) (GameConstants.getPartyPlayHP(mid) > 0 ? GameConstants.getPartyPlayHP(mid) : MapleDataTool.getIntConvert("maxHP", monsterInfoData) * GameConstants.lowMobHPMultiplier));
            }
            stats.setMp(MapleDataTool.getIntConvert("maxMP", monsterInfoData, 0) * 3);
            ...
            if (buffme && stats.getLevel() >= 103) {
                ...
                stats.setPhysicalAttack((int) (MapleDataTool.getIntConvert("PADamage", monsterInfoData, 0) * GameConstants.lowMobPAttackMultiplier));
                stats.setMagicAttack((int) (MapleDataTool.getIntConvert("MADamage", monsterInfoData, 0) * GameConstants.lowMobMAttackMultiplier));
            }
/*
            if (MapleCharacter.tormentmode1 == true) {
                stats.setExp((int)mid == 9300027 ? 0 : (GameConstants.getPartyPlayEXP(mid) > 0 ? GameConstants.getPartyPlayEXP(mid) : MapleDataTool.getIntConvert("exp", monsterInfoData, 0) * GameConstants.T1EXPMultiplier));
                stats.setHeals((byte) (MapleDataTool.getIntConvert("Heals", monsterInfoData, 0) * 2));
                stats.setPDRate((byte) (MapleDataTool.getIntConvert("PDRate", monsterInfoData, 0) * GameConstants.T1mobDefenseMultiplier));
                 stats.setMDRate((byte) (MapleDataTool.getIntConvert("MDRate", monsterInfoData, 0) * GameConstants.T1mobDefenseMultiplier));
                stats.setPDRate((byte) (MapleDataTool.getIntConvert("PDRate", monsterInfoData, 0) * GameConstants.T1bossDefenseMultiplier));
                    stats.setMDRate((byte) (MapleDataTool.getIntConvert("MDRate", monsterInfoData, 0) * GameConstants.T1bossDefenseMultiplier));
                  stats.setPhysicalAttack((int) (MapleDataTool.getIntConvert("PADamage", monsterInfoData, 0) * GameConstants.T1mobPAttackMultiplier));
                stats.setMagicAttack((int) (MapleDataTool.getIntConvert("MADamage", monsterInfoData, 0) * GameConstants.T1mobMAttackMultiplier));
                stats.setHp((long) ((GameConstants.getPartyPlayHP(mid) > 0 ? GameConstants.getPartyPlayHP(mid) : MapleDataTool.getIntConvert("maxHP", monsterInfoData)) * GameConstants.T1mobHPMultiplier));
             
            }
            
              if (MapleCharacter.tormentmode7 == true) {
                stats.setExp((int)mid == 9300027 ? 0 : (GameConstants.getPartyPlayEXP(mid) > 0 ? GameConstants.getPartyPlayEXP(mid) : MapleDataTool.getIntConvert("exp", monsterInfoData, 0) * GameConstants.T7EXPMultiplier));
                stats.setHeals((byte) (MapleDataTool.getIntConvert("Heals", monsterInfoData, 0) * 8));
                stats.setPDRate((byte) (MapleDataTool.getIntConvert("PDRate", monsterInfoData, 0) * GameConstants.T7mobDefenseMultiplier));
                 stats.setMDRate((byte) (MapleDataTool.getIntConvert("MDRate", monsterInfoData, 0) * GameConstants.T7mobDefenseMultiplier));
                stats.setPDRate((byte) (MapleDataTool.getIntConvert("PDRate", monsterInfoData, 0) * GameConstants.T7bossDefenseMultiplier));
                    stats.setMDRate((byte) (MapleDataTool.getIntConvert("MDRate", monsterInfoData, 0) * GameConstants.T7bossDefenseMultiplier));
                  stats.setPhysicalAttack((int) (MapleDataTool.getIntConvert("PADamage", monsterInfoData, 0) * GameConstants.T7mobPAttackMultiplier));
                stats.setMagicAttack((int) (MapleDataTool.getIntConvert("MADamage", monsterInfoData, 0) * GameConstants.T7mobMAttackMultiplier));
                stats.setHp((long) ((GameConstants.getPartyPlayHP(mid) > 0 ? GameConstants.getPartyPlayHP(mid) : MapleDataTool.getIntConvert("maxHP", monsterInfoData)) * GameConstants.T7mobHPMultiplier));
             
            }
            */
            if (buffme && stats.getLevel() >= 55) {
                if (!stats.isBoss()) {
                    ...
                    stats.setHeals((byte) (MapleDataTool.getIntConvert("heals", monsterInfoData, 0) * GameConstants.healmultiplier));
                }
            } 
            stats.setAcc((int) (MapleDataTool.getIntConvert("acc", monsterInfoData, 0)));
            stats.setEva((int) (MapleDataTool.getIntConvert("eva", monsterInfoData, 0)));
