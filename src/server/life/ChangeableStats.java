...
public class ChangeableStats extends OverrideMonsterStats {
    ...
    public ChangeableStats(MapleMonsterStats stats, double newLevel, double hpBuff, double bossHpBuff, double expMulti, double evaMulti) { // Custom hell
        ...
        eva = (int) Math.round((stats.getEva() * evaMulti * Math.max(1, mod)));
