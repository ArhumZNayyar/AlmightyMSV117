...
public class MapleTrade {
    ...
    public static final void visitTrade(final MapleCharacter c1, final MapleCharacter c2) {
	    ...
	    c1.getTrade().inTrade = true;
            ...
            c1.dropMessage(-2, "Rummy : If you get scammed, Please report to a GM. Scam leads to temp ban on first offense. 2nd is perm ban. NOTE: If GM scams you, report to admin.");
        } else {
