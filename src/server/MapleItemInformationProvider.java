...
public class MapleItemInformationProvider {
    ...
    protected final Map<Integer, Map<Integer, StructItemOption>> socketCache = new WeakHashMap<>(); // Grade, (id, data)
    ...
    public void runEtc() {
        ...
        final Map<Integer, StructItemOption> gradeS = new WeakHashMap<>();
        final Map<Integer, StructItemOption> gradeA = new WeakHashMap<>();
        final Map<Integer, StructItemOption> gradeB = new WeakHashMap<>();
        final Map<Integer, StructItemOption> gradeC = new WeakHashMap<>();
        final Map<Integer, StructItemOption> gradeD = new WeakHashMap<>();
