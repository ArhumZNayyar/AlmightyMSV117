...
public abstract class AbstractPlayerInteraction {
    ...
    public final void checkNX() {
        c.getPlayer().getNX();
    }
    
    public final void gainVP(final int hi) {
        c.getPlayer().gainvpoints(hi);
    }
    ...
    public final void gainNX(final int amount) {
     ...
     public final void gainPrepaidNX(final int amount) {
        c.getPlayer().modifyCSPoints(4, amount, true); //theremk you can change it to prepaid yae since cspoiint is xncredit so make it prepaid
          ...
          public final void gainMaplePoints(final int amount) {
        c.getPlayer().modifyCSPoints(2, amount, true); //theremk you can change it to prepaid yae since cspoiint is xncredit so make it prepaid
    }
