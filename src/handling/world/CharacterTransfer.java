...
public class CharacterTransfer implements Externalizable {
    ...
    public long lastfametime, TranferTime, mesosbank;
    ...
    public int reborns, apstorage, Paragons, str, dex, int_, luk, remainingAp;
    ...
    public CharacterTransfer(final MapleCharacter chr) {
        ...
        this.vaccinated = chr.isVaccinated();
        this.monsterkills= chr.monsterkills;
        this.mesosbank = chr.mesosbank;
        this.Paragons = chr.Paragons;
