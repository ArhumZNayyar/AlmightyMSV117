...
/*  228 */                   if (eachd.intValue() >= 2499999) {
     World.Broadcast.broadcastGMMessage(CWvsContext.serverNotice(6, "[RumShield] " + MapleCharacterUtil.makeMapleReadable(player.getName()) + "is using DAMAGE HACKS?! RumShield has D/C'd them. If this is a false report please report it to Rummy so the RumShield protection module can be adjusted." ));
...
/* 1101 */       lea.readInt();
/*      */     }
               if((ret.skill == 24121005) || (ret.skill == 24120043) || (ret.skill == 24120044) || (ret.skill == 24120045)){
                 lea.readInt();
               }
