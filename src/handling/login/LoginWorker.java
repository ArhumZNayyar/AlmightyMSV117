...
public class LoginWorker {
    ...
    public static void registerClient(final MapleClient c) {
        if (LoginServer.isAdminOnly() && !c.isGm()) {
            c.getSession().write(CWvsContext.serverNotice(1, "The server is currently in maintenance mode, so only GM's will be able to login.\r\nPlease check the forums and try again later."));
