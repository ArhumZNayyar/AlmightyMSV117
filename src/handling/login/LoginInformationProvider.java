...
public class LoginInformationProvider {
    ...
    public enum JobType { 
        UltimateAdventurer(-1, "Ultimate", 0, 10000),
        Resistance(0, "Resistance", 3000, 10000),
        Adventurer(1, "", 0, 10000),
        Cygnus(2, "Premium", 1000, 10000 ), //913040000
        Aran(3, "Orient", 2000, 10000),
        Evan(4, "Evan", 2001, 10000),
        Mercedes(5, "", 2002, 10000),
        Demon(6, "", 3001, 10000),
        Phantom(7, "", 2003, 10000),//2003
        DualBlade(8, "", 0, 10000),
        Mihile(9, "", 5000, 10000),
        Jett(10, "", 0, 10000),
        Cannoneer(11, "", 0, 10000);
