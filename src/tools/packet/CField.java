...
/*      */
       ...
       public static byte[] getAndroidTalkStyle(int npc, String talk, int... args) { //fk dis do dis later no one uses this shit
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
            
            mplew.writeShort(SendPacketOpcode.NPC_TALK.getValue()); //if the menu doesnt show obvs its the wrong value <<< 
            mplew.write(4);
            mplew.writeInt(npc);
            mplew.writeShort(10); // i think lol fkin dinnerdaner
            mplew.writeMapleAsciiString(talk);
            mplew.write(args.length);
            
            for(int i = 0; i < args.length; i++) { //shows styles
...
/*      */     }
/*      */ 
/*      */     public static byte[] showOwnCraftingEffect(String effect, int time, int mode, int item, MapleClient c) {
       return showCraftingEffect(-1, effect, time, mode, item, c);
     }

    public static byte[] showCraftingEffect(int cid, String effect, int time, int mode, int itemID, MapleClient c) {
       MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
       ...
       mplew.write(c.getPlayer().getDirection());
       mplew.writeInt(time);
       mplew.writeInt(mode);
       if (mode == 2) {
         mplew.writeInt(itemID); //itemid
       }
...
/*      */
        ...
        public static Object showOwnCraftingEffect(String effect, int time, int i) {
            throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        }

        public static byte[] showCraftingEffect(int id, String effect, int time, int i) {
            throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        }
   }
