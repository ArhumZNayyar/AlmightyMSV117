...
public class DataTool {
    ...
    private static MapleDataProvider data = MapleMonsterInformationProvider.getMobDataProvider();
    ...
    public static ArrayList<Integer> itemIdsFromName(String name) {
        ArrayList<Integer> ret = new ArrayList<Integer>();
        for (Pair<Integer, String> itemPair : MapleItemInformationProvider.getAllItems()) {
