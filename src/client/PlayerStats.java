...
public class PlayerStats implements Serializable {
    ...
    public transient double expBuff, dropBuff, mesoBuff, cashBuff, mesoGuard, mesoGuardMeso, expMod, pickupRange, dam_r, bossdam_r, dropMod;
    ...
    public transient int def, element_ice, element_fire, element_light, element_psn, evaR;
    ...
    public void recalcLocalStats(boolean first_login, MapleCharacter chra) {
        ...
        while (iter.hasNext()) {
         ...
         if (chra.getReborns() >= 5) {
            expMod = 0.92; //drops from 100% to 95% 
            dropMod = 0.93; //drops from 100% to 93% 
        }
        if (chra.getReborns() >= 10) {
            expMod = 0.84; //drops from 95% to 85% 
            dropMod = 0.82; //drops from 93% to 82% 
            
        }
        if (chra.getReborns() >= 15) {
            expMod = 0.72; //drops from 95% to 85% 
            dropMod = 0.82; //drops from 93% to 82% 
            
        }
        if (chra.getReborns() >= 20) {
        expMod = 0.64;
        dropMod = 0.68;
    }
        if (chra.getReborns() >= 30) {
        expMod = 0.53;
        dropMod = 0.68;
    }
        
        if (chra.getReborns() >= 40) {
        expMod = 0.47;
        dropMod = 0.68;
    }
        
        if (chra.getReborns() >= 50) {
        expMod = 0.38;
        dropMod = 0.68;
    }
        if (chra.getReborns() >= 60) {
        expMod = 0.38;
        dropMod = 0.68;
    }
        
        if (chra.getReborns() >= 100) {
            expMod = 0.6;
            dropMod = 0.10;
        }
        ...
        for (Item item : chra.getInventory(MapleInventoryType.CASH).newList()) {
            if (item.getItemId() / 100000 == 52) {
                ...
                else if (chra.getReborns() >= 15 && (item.getItemId() == 5210000 || item.getItemId() == 5210001 || item.getItemId() == 5210002 || item.getItemId() == 5210003 || item.getItemId() == 5210004 || item.getItemId() == 5210005 || item.getItemId() == 5211061 || item.getItemId() == 5211000 || item.getItemId() == 5211001 || item.getItemId() == 5211002 || item.getItemId() == 5211003 || item.getItemId() == 5211046 || item.getItemId() == 5211047 || item.getItemId() == 5211048 || item.getItemId() == 5211049)) {
                    expMod = 0.85;
                }
                else if (chra.getReborns() >= 20 && (item.getItemId() == 5210000 || item.getItemId() == 5210001 || item.getItemId() == 5210002 || item.getItemId() == 5210003 || item.getItemId() == 5210004 || item.getItemId() == 5210005 || item.getItemId() == 5211061 || item.getItemId() == 5211000 || item.getItemId() == 5211001 || item.getItemId() == 5211002 || item.getItemId() == 5211003 || item.getItemId() == 5211046 || item.getItemId() == 5211047 || item.getItemId() == 5211048 || item.getItemId() == 5211049)) {
                    expMod = 0.64;
                }
                else if (chra.getReborns() >= 30 && (item.getItemId() == 5210000 || item.getItemId() == 5210001 || item.getItemId() == 5210002 || item.getItemId() == 5210003 || item.getItemId() == 5210004 || item.getItemId() == 5210005 || item.getItemId() == 5211061 || item.getItemId() == 5211000 || item.getItemId() == 5211001 || item.getItemId() == 5211002 || item.getItemId() == 5211003 || item.getItemId() == 5211046 || item.getItemId() == 5211047 || item.getItemId() == 5211048 || item.getItemId() == 5211049)) {
                    expMod = 0.65;
                }
                else if (chra.getReborns() >= 40 && (item.getItemId() == 5210000 || item.getItemId() == 5210001 || item.getItemId() == 5210002 || item.getItemId() == 5210003 || item.getItemId() == 5210004 || item.getItemId() == 5210005 || item.getItemId() == 5211061 || item.getItemId() == 5211000 || item.getItemId() == 5211001 || item.getItemId() == 5211002 || item.getItemId() == 5211003 || item.getItemId() == 5211046 || item.getItemId() == 5211047 || item.getItemId() == 5211048 || item.getItemId() == 5211049)) {
                    expMod = 0.54;
                }
    ...
    private void handlePassiveSkills(final MapleCharacter chra) {
        ...
        final double[] baseAddition = {1, 1, 1, 1.1, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2, 1.2};
        final double[] mesoMulti = {1, 1, 1, 1, 1.12, 1.14, 1.26, 1.38, 1.45, 1.51, 1.64, 1.75, 1.86, 2.97, 3.8, 4.9, 6.10, 12.11};
        final double[] dropIncrease = {1, 1, 1, 1.12, 1.14, 1.26, 1.38, 1.54, 1.65, 1.87, 1.94, 2, 3, 4, 5, 6, 8, 15, 30}; //drop rate boost, in percent
        ...
        switch (chra.getJob()) {
            ...
            case 232: {
                ...
                if (bof > 0) {
                  ...
                  bx = SkillFactory.getSkill(9101002);
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0 && chra.getReborns() >= 8) {
                    expMod = 0.94; //change to 81
                }
                if (bof > 0 && chra.getReborns() >= 15) {
                    expMod = 0.88; //change to 81
                }
                if (bof > 0 && chra.getReborns() >= 20) {
                    expMod = 0.68; //change to 81
                }
                  if (bof > 0 && chra.getReborns() >= 30) {
                      expMod = 0.73;
                  }
                   if (bof > 0 && chra.getReborns() >= 40) {
                      expMod = 0.64;
                   }
                     if (bof > 0 && chra.getReborns() >= 50) {
                     expMod = 0.54;
                     }
                       if (bof > 0 && chra.getReborns() >= 60) {
                           expMod = 0.46;
                       }
                      if (bof > 0 && chra.getReborns() >= 70) {
                           expMod = 0.37;
                       }
                      if (bof > 0 && chra.getReborns() >= 80) {
                           expMod = 0.27;
                       }
                      if (bof > 0 && chra.getReborns() >= 90) {
                           expMod = 0.17;
                       }
                      if (bof > 0 && chra.getReborns() >= 100) {
                           expMod = 0.7;
                       }
              
                bx = SkillFactory.getSkill(2311003);
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0 && chra.getReborns() >= 8) {
                    expMod = 0.94; //change to 81
                }
                ...
                bx = SkillFactory.getSkill(2320046);
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0 && chra.getReborns() >= 8) {
                    expMod = 0.94; //change to 81
                }
            ...
            case 572: { // Jett
                ...
                if (bof > 0) {
                 ...
                 bx = SkillFactory.getSkill(15000000); // Comet Booster
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    ...
                    speed += eff.getSpeedMax(); // TODO: split speed max and speed. (speed have a limit, while speedMax will add to the max)
                         ...
                         bx = SkillFactory.getSkill(5090000); // Comet Booster
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    accuracy += eff.getAccX();
   ...
   //                 maxhp += eff.getX();
     ...
     //               wdef += eff.getX();
        ...
        if (GameConstants.isAdventurer(chra.getJob())) {
            ...
            bx = SkillFactory.getSkill(0000110);
            bof = chra.getSkillLevel(bx);
            if (bof > 0) {
                eff = bx.getEffect(bof);
                localstr += eff.getStrX();
...
/*                bx = SkillFactory.getSkill(5220001);
      ...
      /*  if((incMesoProp - 100) > GameConstants.mesoRateCap){
        ...
        //HC mode increases
        if(chra.getHcMode() == 1){
            expBuff += GameConstants.hcExpRate;
            incMesoProp += GameConstants.hcMesoRate;
            dropBuff += GameConstants.hcDropRate;
        } */
    }
    ...
    private void handleBuffStats(MapleCharacter chra) {
        ...
        if (buff != null) {
            mesoBuff *= buff.doubleValue() / 100.0 + 10;
        }
